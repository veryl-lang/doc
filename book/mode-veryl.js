...
var VerylHighlightRules = function () {
    var keywords = "always_comb|always_ff|as|assign|bit|clock|clock_posedge|clock_negedge|else|enum|export|" +
        ...
        "package|param|pub|ref|repeat|reset|reset_async_high|reset_async_low|reset_sync_high|reset_sync_low|return|signed|step|struct|tri|u32|u64|var|let|break|embed|include|case|switch|unsafe|type|const|proto|converse";
